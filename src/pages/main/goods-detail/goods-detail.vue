      ...
      <section class="share-panel" :class="{show: showSharePanel}">
        <div class="container">
          ...
          <nav class="container-item-wrapper" @click="_actionDrawPoster">
            ...
            <p class="text">{{poster? '保存海报' : '保存海报'}}</p>
          </nav>
        </div>
      </section>
    </article>
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    onShareAppMessage() {
      ...
      console.info(`${this.$routes.main.PACKAGE}/${PAGE_ROUTE_NAME}?id=${this.goodsId}&shopId=${shopId}&activityId=${this.activityId}&activityType=${this.activityType}&flag=${flag}`)
      return {
